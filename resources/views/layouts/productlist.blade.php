<body style="background-color: #FFFFFF" ng-controller="productolistController">
        ...
        <div class="row">
            <div class="grid-products container">
                <div class="grid-products col-md-12 col-xs-12 container">
                    <div class="sub-title">
                        <h3>Lista de productos publicados por: @{{username}}</h3>
                    </div>
                    <a style="margin-bottom: 15px" href="/publicacion/@{{publicacion.publicacion.id}}" ng-repeat="publicacion in publicaciones | limitTo : 7">
